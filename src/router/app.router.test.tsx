...
vi.mock('@/heroes/pages/hero/HeroPage', () => ({
    HeroPage: () => {
        ...
        return (
            <div data-testid='hero-page'>Hero Page - {idSlug}</div>
        )
    }
}))
...
describe('appRouter ', () => {
    ...
    test('should render home page at root path', () => {
        // this createMemoryRouter works for creating a testing imitation of the approuter that I use on the application
