  ...
  return (
    <div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        >
          <div className="text-2xl font-bold text-red-600" data-testid="favorite-count">{favoritesCount}</div>
          <p className="text-xs text-muted-foreground"
            data-testid="favorite-percentage"
          >
            {((favoritesCount / (summary?.totalHeroes || 1)) * 100).toFixed(2)}% of total
          </p>
        </HeroStatCard>
